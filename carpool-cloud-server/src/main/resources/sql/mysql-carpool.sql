...
CREATE TABLE `cp_user` (
  ...
  `real_name` varchar(32) CHARACTER SET utf8mb4 DEFAULT '' COMMENT '真实名字',
  `user_name` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '昵称',
